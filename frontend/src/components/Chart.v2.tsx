 ...
 * ON PAGE LOAD IT DISPLAYS 100 DATA POINTS FROM DATABASE
 * THEN IT HAS SOCKET CONNECTION AND IT GETS NEW DATA EVERY FEW SECONDS NON STOP
 * IT GETS NEW DATA VIA newData PROP
 * IT SHOULD DISPLAY NEW DATA TOOGETHER WITH PREVIOUS DATA, BUT KEEP TOTAL SIZE OF 100 DATA POINTS,
 * SO IT SHOULD REMOVE OLD DATA PIECE BY PIECE.
 * CURRENTLY IT KEEPS ADDING NEW DATA TO MY DATA ARRAY AND IT IS KEEPS GROWING. THIS IS WRONG.
 * CAN YOU FIND AND FIX THE ISSUE?
 * MAYBE RECIEVING NEW DATA PERIODICALLY THROUGHT newData
 */
